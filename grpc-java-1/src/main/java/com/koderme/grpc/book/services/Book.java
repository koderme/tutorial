package com.koderme.grpc.book.services;

import com.google.protobuf.Descriptors;
import com.koderme.grpc.proto.book.BookOuterClass;
import com.koderme.grpc.proto.book.BookServiceGrpc;
...
public class Book extends BookServiceGrpc.BookServiceImplBase {
    ...
    @Override
    public void setBook(BookOuterClass.Book request, StreamObserver<BookOuterClass.Empty> responseObserver) {
        books.add(request);

        BookOuterClass.Empty.Builder response = BookOuterClass.Empty.newBuilder();
        responseObserver.onNext(response.build());
        responseObserver.onCompleted();
    }

    @Override
    public void getPage(BookOuterClass.PageRequest request, StreamObserver<BookOuterClass.PageResponse> responseObserver) {
        /* Get Book */
        ...
        if (book == null) {
            ...
            if (page == null) {
                ...
                responseObserver.onNext(BookOuterClass.PageResponse.newBuilder().setPage(page).build());
                responseObserver.onCompleted();
            }
        }
    }
    ...
    @Override
    public void setPage(BookOuterClass.Page request, StreamObserver<BookOuterClass.Empty> responseObserver) {
        /* Get Book */
        ...
        if (searchedBook == null) {
            ...
            if (found == true) {
                ...
                BookOuterClass.Page page = BookOuterClass.Page.newBuilder()
                ...
                responseObserver.onNext(BookOuterClass.Empty.newBuilder().build());
                responseObserver.onCompleted();
            }
        }
    }
    ...
    @Override
    public StreamObserver<BookOuterClass.Page> setPages(StreamObserver<BookOuterClass.Empty> responseObserver) {
